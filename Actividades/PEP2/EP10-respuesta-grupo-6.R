...
# lo cual se puede contrarrestar para el problema dado como una "igualdad" 
...
# 1. La variable independiente tiene tres niveles por lo cual se cumple que se deba tener a lo menos dos niveles.
# 2. La escala de medición empleada es a lo menos ordinal, ya que, se habla de de puntajes obtenidos
# 3. Se puede asumir que las observaciones son independientes ente sí debido a que
...
# Respuesta : Como P < alfa, se rechaza H0 a favor de HA, es decir, con un 99% de confianza se concluye que
#             Hay diferencias significativas entre las puntuaciones para el envase de queque diseñado por KoolDesign
#             Con respecto a las edades. Mediante el resultados del procedimiento post-hoc, considerando un
#             nivel de significación alpha = 0,01, podemos concluir con 99% de confianza que existen diferencias
#             significativas para todos los grupos de evaluadores son distintos respecto a las puntuaciones.
