# Actividad 9 IME
# Grupo 6: Angel Avendaño, Jorge González y Juan VÃ¡squez
...
# H0: Las diferencias de las medias en el tiempo que tardan los usuarios de leyes en formular una consulta para los problemas de distinta dificultad.

# HA: Al menos una de las muestras presenta una diferencia significativa en el tiempo que tardan los usuarios de leyes en formular una consulta para
# los problemas de distinta dificultad..
